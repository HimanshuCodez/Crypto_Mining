...
<div className='flex items-center justify-between w-full'>
  <label htmlFor="country" className='flex flex-col justify-start items-start gap-1'>
    ...
    <input type="text" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2' placeholder='select country' name="" id="" />
  </label>
  <label htmlFor="mobile" className='flex flex-col justify-start items-start gap-1'>
    ...
    <input type="tel" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2' placeholder='enter your mobile' name="" id="" />
  </label>
</div>
<label htmlFor="email" className='flex flex-col justify-start items-start gap-1'>
    ...
    <input type="email" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2' placeholder='enter your email' name="" id="" />
  </label>
  <div className='flex items-center justify-between w-full'>
  ...
  <label htmlFor="passwordCheck" className='flex flex-col justify-start items-start gap-1'>
    ...
    <input type="password" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2' placeholder='Enter Confirm Pass' name="" id="" />
  </label>
</div>
<label htmlFor="referalCode" className='flex flex-col justify-start items-start gap-1'>
    <span className='text-sm capitalize text-black font-medium'>Referral Code</span>
    <input type="text" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2' placeholder='' name="" id="" />
  </label>
...
<label className='flex flex-row-reverse justify-end items-center gap-3 px-3 py-4'>
    ...
    <span><span className='font-medium text-lg'>Already Have A Account? </span><Link to="/dashboard"> <span className='text-[#31B8A1] capitalize hover:underline '>sign in</span></Link></span>
</div>
</form>
</div>
</div>
