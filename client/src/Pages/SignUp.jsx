        ...
        <div className='w-full min-h-screen px-4 sm:px-10 bg-[#31B8A1] flex items-center justify-center'>
            <div className='grid grid-cols-1 md:grid-cols-2 max-w-6xl w-full'>
                ...
                <div className='flex flex-col gap-6 bg-white rounded-b-lg md:rounded-bl-none md:rounded-r-lg px-5 py-10'>
                    <h1 className='font-medium text-3xl sm:text-4xl capitalize text-center md:text-left'>create account</h1>
                    <form onSubmit={handleSubmit} className="w-full">
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex flex-col sm:flex-row items-center justify-between w-full gap-5'>
                                <label htmlFor="country" className='flex flex-col justify-start items-start gap-1 w-full'>
                                    <span className='text-sm capitalize text-black font-medium'>country</span>
                                    <select onChange={handleChange} value={formData.country} name="country" className='outline-none w-full border rounded-2xl placeholder:text-[#000000B2] placeholder:capitalize placeholder:text-sm p-2'>
                                ...
                                <label htmlFor="mobile" className='flex flex-col justify-start items-start gap-1 w-full'>
                            ...
                            <div className='flex flex-col sm:flex-row items-center justify-between w-full gap-5'>
                                ...
                                <label htmlFor="passwordCheck" className='flex flex-col justify-start items-start gap-1 w-full'>
                            ...
                            <span className="text-center"><span className='font-medium text-lg'>Already Have An Account? </span><Link to="/login"> <span className='text-[#31B8A1] capitalize hover:underline '>sign in</span></Link></span>
                        </div>
                    </form>
                </div>
            </div>
