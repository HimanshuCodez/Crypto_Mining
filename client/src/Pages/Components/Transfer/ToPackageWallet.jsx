    ...
    return (
        <div className='w-full flex flex-col gap-6 p-4 md:p-6 font-[Inter]'>
            <div className='flex flex-col justify-start items-start gap-2'>
                <h2 className='text-2xl md:text-4xl font-medium capitalize font-[Inter]'>Transfer To Package Wallet</h2>
                <nav className='flex items-center gap-1 capitalize font-light text-sm font-[Inter]'>
                    <a href="/Transfer">Transfer</a><span>/</span><a href="/wallet" className='text-[#02AC8F] truncate'>Transfer To Package Wallet</a>
                </nav>
            </div>
            <div className='bg-[#FFFFFF] w-full rounded-3xl px-4 md:px-5 py-10 flex flex-col gap-5'>
                ...
                <h2 className='text-xl md:text-3xl font-[Inter] font-medium py-3'>Package Wallet Details</h2>
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <label htmlFor="password" className='flex flex-col justify-start items-start gap-1 w-full md:w-1/2'>
